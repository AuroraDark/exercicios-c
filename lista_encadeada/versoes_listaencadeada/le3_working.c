...
int main()
{
	...
	printf("Bem Vindo ao programa da Lista Encadeada!!\n\n O programa ja vem com uma lista pronta com 3 nos(nos sao os elementos da lista, eles sao interligados pelo endereco do prox, que aponta o proximo no, fazendo assim a lista)(10, 20 e 30), o 10 eh o no CABECA, ou seja, ele eh o INICIO da lista, e o 30 eh o no FINAL, pra saber disso so olhar o ENDERECO PROX dele, que eh NULL (00000000000000)");
	printf("\n\nRepare que o endereco prox do no eh igual ao endereco do no debaixo (pra voce ver isso comeca digitando 5, que eh a opcao exibir lista), isso eh o que os liga");
